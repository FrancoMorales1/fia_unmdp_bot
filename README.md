...
pnpm dev                      # scrapea al toque y muestra el QR
```

El scrapeo inicial corre solo, como parte del arranque (`SCRAPPER_AL_INICIAR`
por defecto en `true`), así que la base no queda vacía hasta las 4am.
